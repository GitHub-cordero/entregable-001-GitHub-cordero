			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
				<div class="leftbar p-r-20 p-r-0-sm">
					...
					<ul class="p-b-54">
						...
						<c:forEach var="categoria" items="${categrias }">
						<li class="p-t-4"><a href="#" class="s-text13"> ${categoria.nombre } </a></li>
						</c:forEach>
						...
						<ul class="flex-w">
							...
							<c:forEach var="color" items="${colores }">
								<li class="m-r-10"><input class="checkbox-color-filter"
									...
									<label style="background-color:${color.nombre}"class="color-filter color-filter1" for="color-filter1"></label>
								</li>
							</c:forEach>
				...
				<div class="flex-sb-m flex-w p-b-35">
					...
					<span class="s-text8 p-t-5 p-b-5"> 
						<c:if test="${productos.size()>1}">
							${productos.size()} Resultados 
						</c:if>
						<c:if test="${productos.size()==1}">
							${productos.size()} Resultado
						</c:if>
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div
									...
									<img
										src="${pageContext.request.contextPath }/assets/images/${producto.urlimg}"
										alt="IMG-PRODUCT">
